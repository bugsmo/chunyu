...
func (u *OrganizationUpsertOne) UpdateNewValues() *OrganizationUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		...
		if _, exists := u.create.mutation.UpdateTime(); exists {
			s.SetIgnore(organization.FieldUpdateTime)
		}
		if _, exists := u.create.mutation.DeleteTime(); exists {
			s.SetIgnore(organization.FieldDeleteTime)
		}
	}))
	return u
}
...
func (u *OrganizationUpsertBulk) UpdateNewValues() *OrganizationUpsertBulk {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		for _, b := range u.create.builders {
			...
			if _, exists := b.mutation.DeleteTime(); exists {
				s.SetIgnore(organization.FieldDeleteTime)
			}
		}
	}))
